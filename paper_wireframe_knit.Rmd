...
dmod<-dmod[,c(1,2,6,22,27,28,29,37,39,52,57,63,74,85,87,92, 115)]
...
Taking a step back, it is important to if there is any environmental
control over how birds arrive into West Africa.
...
OK so are there any explanatory variables that can improve a model
