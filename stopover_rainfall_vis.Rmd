...
szr<-length(unique(paste(int_out[int_out$ptt==j & int_out$year==i,]$country,int_out[int_out$ptt==j & int_out$year==i,]$SO_startDOY )))

temp=ggplot(data=int_out[int_out$ptt==j & int_out$year==i,], 
